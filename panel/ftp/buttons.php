	     ...
	     <div class="container">
	        <div class="row">
	           <div class="col-md-5">
	              <!-- Logo -->
	              <div class="logo">
	                 <h1><a href="#" download>ftp panel</a></h1>
	              </div>
	           </div>
	           <div class="col-md-5">
	              <div class="row">
            ...
            <div class="content-box-large">
              <div class="panel-body">
                    ...
                    <p>
                      ...
                      <button class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-arrow-left"></span></button>
                    ...
                    <p>
                      ...
                      <button class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-arrow-left"></span></button>
                    ...
                    <p>
                      ...
                      <button class="btn btn-primary"><span class="glyphicon glyphicon-arrow-left"></span></button>
                    ...
                    <p>
                      ...
                      <button class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-arrow-left"></span></button>
                ...
                <p>
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                      <li><button class="btn">Info</button></li>
